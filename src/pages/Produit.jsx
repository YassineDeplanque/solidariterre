  ...
  const produits = [
    {
      ...
      description: "Un assortiment de légumes de saison cultivés localement.",
      price: "15€",
      image: "/images/panier-legumes.jpg",
    },
    {
      id: 2,
      name: "Œufs frais",
      description: "Oeufs de poules élevées en plein air, fraîcheur garantie.",
      price: "5€ la douzaine",
    ...
    },
    {
      id: 3,
      name: "Fruits rouges",
      description: "Fraises, framboises et myrtilles, cueillies à maturité.",
      price: "12€ le panier",
      image: "/images/fruits-rouges.jpg",
    },
  ];
        ...
        {produits.map((produit) => (
          ...
          >
            ...
            <button
              ...
              onClick={() => alert(`Ajouté au panier: ${produit.name}`)}
            >
              Ajouter au panier
            </button>
          </div>
